...
1. Double-click `WinTabsGo-zh-2026092501.msi`.
2. Finish the wizard.
3. Start WinTabsGo from the Start menu or the desktop shortcut.

Windows records the installer version as `26.09.25.1`. The tray icon and the Settings window show `zh-2026092501`. Windows Installer only accepts a numeric version.

## Portable package

1. Unzip `WinTabsGo-zh-2026092501.zip` into a folder you can write to.
