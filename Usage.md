...
1. Double-click `WinTabsGo-zh_2026.09.26.3.msi`.
2. Finish the wizard.
3. Start WinTabsGo from the Start menu or the desktop shortcut.

Windows records the installer version as `26.09.26.3`. The tray icon and the Settings window show `zh_2026.09.26.3`. Windows Installer only accepts a numeric version.

## Portable package

1. Unzip `WinTabsGo-zh_2026.09.26.3.zip` into a folder you can write to.
